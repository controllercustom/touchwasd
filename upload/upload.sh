#!/usr/bin/env bash
# Upload the precompiled touchWASD firmware to a LilyGo T-Dongle-S3.
#
# Usage:
#   ./upload.sh [PORT]
#
...
#
# The binaries in ./build/tdongle_s3 were built with:
...
INPUT_DIR="${SCRIPT_DIR}/build/tdongle_s3"
...
echo "Uploading T-Dongle-S3 touchWASD firmware to ${PORT} ..."
